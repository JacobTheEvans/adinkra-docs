    ...
    return (
      <section className="vanilla-content">
        ...
        <section className="doc-section">
          ...
          <p>Adinkra Symbols Font are scalable vector icons that can change color, size, padding and anything else that can be done with CSS.</p>
        </section>

        <section className="doc-section">
          <h3>How to use it</h3>
          <p>To use the Adinkra Symbols in a website simply include the CDN link in the head of your HTML</p>
          <SyntaxHighlighter language="html" style={atelierCaveLight} customStyle={{backgroundColor: "white", fontSize: "16px"}}>
